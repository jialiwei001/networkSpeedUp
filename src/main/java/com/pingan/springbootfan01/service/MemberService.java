...
public interface MemberService {
    ...
    public Page<Member> findMenbers(LocalUser localUser,  String urlAdress, String phone,String email,String sortOrder,String type, String start,String end, int pa, int si);
